...
#undef doGain
void doGain ( hls::stream< ap_axis< 32 ,2 ,5 ,6 > > & inStream,  hls::stream< ap_axis< 32 ,2 ,5 ,6 > > & outStream,  int gain) {
    ...
    if (wrapc_switch_file_token.good()) {
                ...
                for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
                    ...
                    for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                        ...
                        if(&(aesl_tmp_3[0]) != 0) {
                           ...
                           aesl_tmp_3[i_0].data = (sc_bv<32>(outStream_V_data_V_pc_buffer[0 + AESL_i].range(31, 0))).to_string(SC_BIN).c_str();
                ...
                for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
                    ...
                    for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                        ...
                        if(&(aesl_tmp_3[0]) != 0) {
                           ...
                           aesl_tmp_3[i_0].keep = (sc_bv<4>(outStream_V_keep_V_pc_buffer[0 + AESL_i].range(3, 0))).to_string(SC_BIN).c_str();
                ...
                for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
                    ...
                    for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                        ...
                        if(&(aesl_tmp_3[0]) != 0) {
                           ...
                           aesl_tmp_3[i_0].strb = (sc_bv<4>(outStream_V_strb_V_pc_buffer[0 + AESL_i].range(3, 0))).to_string(SC_BIN).c_str();
        ...
        gain_tvin_wrapc_buffer.range(31, 0) = gain;
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_0[0]) != 0) {
                   ...
                   inStream_V_data_V_tvin_wrapc_buffer[0 + AESL_i].range(31, 0) = (aesl_tmp_0[i_0].data).to_string(2).c_str();
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_0[0]) != 0) {
                   ...
                   inStream_V_keep_V_tvin_wrapc_buffer[0 + AESL_i].range(3, 0) = (aesl_tmp_0[i_0].keep).to_string(2).c_str();
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_0[0]) != 0) {
                   ...
                   inStream_V_strb_V_tvin_wrapc_buffer[0 + AESL_i].range(3, 0) = (aesl_tmp_0[i_0].strb).to_string(2).c_str();
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_3[0]) != 0) {
                   ...
                   outStream_V_data_V_tvout_wrapc_buffer[0 + AESL_i].range(31, 0) = (aesl_tmp_3[i_0].data).to_string(2).c_str();
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_3[0]) != 0) {
                   ...
                   outStream_V_keep_V_tvout_wrapc_buffer[0 + AESL_i].range(3, 0) = (aesl_tmp_3[i_0].keep).to_string(2).c_str();
        ...
        for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1 ; i_0+= 1) {
            ...
            for (int i_1 = 0; i_1 <= 0 ; i_1+= 1) {
                ...
                if(&(aesl_tmp_3[0]) != 0) {
                   ...
                   outStream_V_strb_V_tvout_wrapc_buffer[0 + AESL_i].range(3, 0) = (aesl_tmp_3[i_0].strb).to_string(2).c_str();
