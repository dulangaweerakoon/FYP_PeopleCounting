...
//------------------------Parameter----------------------
`define TV_IN_outStream_TDATA "../tv/cdatafile/c.doGain.autotvin_outStream_V_data_V.dat"
`define TV_OUT_outStream_TDATA "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_data_V.dat"
`define TV_IN_outStream_TKEEP "../tv/cdatafile/c.doGain.autotvin_outStream_V_keep_V.dat"
`define TV_OUT_outStream_TKEEP "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_keep_V.dat"
`define TV_IN_outStream_TSTRB "../tv/cdatafile/c.doGain.autotvin_outStream_V_strb_V.dat"
`define TV_OUT_outStream_TSTRB "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_strb_V.dat"
`define TV_IN_outStream_TUSER "../tv/cdatafile/c.doGain.autotvin_outStream_V_user_V.dat"
`define TV_OUT_outStream_TUSER "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_user_V.dat"
`define TV_IN_outStream_TLAST "../tv/cdatafile/c.doGain.autotvin_outStream_V_last_V.dat"
`define TV_OUT_outStream_TLAST "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_last_V.dat"
`define TV_IN_outStream_TID "../tv/cdatafile/c.doGain.autotvin_outStream_V_id_V.dat"
`define TV_OUT_outStream_TID "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_id_V.dat"
`define TV_IN_outStream_TDEST "../tv/cdatafile/c.doGain.autotvin_outStream_V_dest_V.dat"
`define TV_OUT_outStream_TDEST "../tv/rtldatafile/rtl.doGain.autotvout_outStream_V_dest_V.dat"
// Input and Output
input clk;
input reset;
input [31 : 0] TRAN_outStream_TDATA;
input [3 : 0] TRAN_outStream_TKEEP;
input [3 : 0] TRAN_outStream_TSTRB;
...
//------------------------Local signal-------------------
reg [31 : 0] mem_outStream_TDATA [999 : 0];
...
reg [11 : 0]  outStream_TDATA_mInPtr  =   0;
reg [11 : 0]  outStream_TDATA_mOutPtr =   0;
reg  outStream_TDATA_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [3 : 0] mem_outStream_TKEEP [999 : 0];
...
reg [11 : 0]  outStream_TKEEP_mInPtr  =   0;
reg [11 : 0]  outStream_TKEEP_mOutPtr =   0;
reg  outStream_TKEEP_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [3 : 0] mem_outStream_TSTRB [999 : 0];
...
reg [11 : 0]  outStream_TSTRB_mInPtr  =   0;
reg [11 : 0]  outStream_TSTRB_mOutPtr =   0;
reg  outStream_TSTRB_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [1 : 0] mem_outStream_TUSER [999 : 0];
...
reg [11 : 0]  outStream_TUSER_mInPtr  =   0;
reg [11 : 0]  outStream_TUSER_mOutPtr =   0;
reg  outStream_TUSER_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [0 : 0] mem_outStream_TLAST [999 : 0];
...
reg [11 : 0]  outStream_TLAST_mInPtr  =   0;
reg [11 : 0]  outStream_TLAST_mOutPtr =   0;
reg  outStream_TLAST_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [4 : 0] mem_outStream_TID [999 : 0];
...
reg [11 : 0]  outStream_TID_mInPtr  =   0;
reg [11 : 0]  outStream_TID_mOutPtr =   0;
reg  outStream_TID_mFlag_nEF_hint;  // 0: empty hint, 1: full hint

reg [5 : 0] mem_outStream_TDEST [999 : 0];
...
reg [11 : 0]  outStream_TDEST_mInPtr  =   0;
reg [11 : 0]  outStream_TDEST_mOutPtr =   0;
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TDATA_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TKEEP_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TSTRB_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TUSER_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TLAST_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TID_mInPtr < 1000) begin
...
always @ (posedge clk) begin
    if (reset === 0) begin
	    ...
	    if(outStream_TDEST_mInPtr < 1000) begin
