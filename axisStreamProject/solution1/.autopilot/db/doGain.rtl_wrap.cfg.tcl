...
set rawDecl [list "void" "doGain\(hls::stream<intSdCh> &inStream,hls::stream<intSdCh> &outStream,int gain\)"]
set argAPint ""
set returnAPint ""
set portList ""
set portName0 "inStream"
set portInterface0 "[list AP_STREAM 0]"
set structName0 "ap_axis<32, 2, 5, 6>"
...
set portData0 [list $structName0 "struct ap_axis " $structMember0 0 0 $structParameter0 $structArgument0]
set portPointer0 "2"
set portArrayDim0 0
set portConst0 "0"
set portVolatile0 "0"
...
set structName1 "ap_axis<32, 2, 5, 6>"
...
set portData1 [list $structName1 "struct ap_axis " $structMember1 0 0 $structParameter1 $structArgument1]
set portPointer1 "2"
set portArrayDim1 0
set portConst1 "0"
set portVolatile1 "0"
