...
const sc_lv<2> doHist::ap_ST_st1_fsm_0 = "00";
const sc_lv<2> doHist::ap_ST_st2_fsm_1 = "1";
const sc_lv<2> doHist::ap_ST_st3_fsm_2 = "10";
const sc_lv<2> doHist::ap_ST_st4_fsm_3 = "11";
const int doHist::C_DATA_WIDTH = "100000";
...
doHist::doHist(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    doHist_CRTL_BUS_s_axi_U->ARESETN(ap_rst_n);
    doHist_CRTL_BUS_s_axi_U->ACLK_EN(doHist_CRTL_BUS_s_axi_U_ap_dummy_ce);
    ...
    SC_METHOD(thread_doHist_CRTL_BUS_s_axi_U_ap_dummy_ce);

    SC_METHOD(thread_exitcond2_fu_130_p2);
    sensitive << ( ap_CS_fsm );
    sensitive << ( idxHist_reg_107 );

    SC_METHOD(thread_exitcond_fu_147_p2);
    sensitive << ( ap_CS_fsm );
    sensitive << ( ap_sig_bdd_86 );
    sensitive << ( idxPixel_reg_118 );
    ...
    sensitive << ( ap_CS_fsm );
    sensitive << ( histo_addr_1_reg_191 );
    ...
    SC_METHOD(thread_idxHist_1_fu_136_p2);
    sensitive << ( idxHist_reg_107 );

    SC_METHOD(thread_idxPixel_1_fu_153_p2);
    sensitive << ( idxPixel_reg_118 );
    ...
    sc_trace(mVcdFile, doHist_CRTL_BUS_s_axi_U_ap_dummy_ce, "doHist_CRTL_BUS_s_axi_U_ap_dummy_ce");
    sc_trace(mVcdFile, idxHist_1_fu_136_p2, "idxHist_1_fu_136_p2");
    sc_trace(mVcdFile, idxPixel_1_fu_153_p2, "idxPixel_1_fu_153_p2");
    sc_trace(mVcdFile, idxPixel_1_reg_186, "idxPixel_1_reg_186");
    sc_trace(mVcdFile, exitcond_fu_147_p2, "exitcond_fu_147_p2");
    sc_trace(mVcdFile, ap_sig_bdd_86, "ap_sig_bdd_86");
    sc_trace(mVcdFile, histo_addr_1_reg_191, "histo_addr_1_reg_191");
    sc_trace(mVcdFile, idxHist_reg_107, "idxHist_reg_107");
    sc_trace(mVcdFile, exitcond2_fu_130_p2, "exitcond2_fu_130_p2");
    sc_trace(mVcdFile, idxPixel_reg_118, "idxPixel_reg_118");
...
void doHist::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,2,2>(ap_ST_st2_fsm_1, ap_CS_fsm.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_130_p2.read()))) {
        idxHist_reg_107 = idxHist_1_fu_136_p2.read();
    ...
    } else if (esl_seteq<1,2,2>(ap_ST_st4_fsm_3, ap_CS_fsm.read())) {
        idxPixel_reg_118 = idxPixel_1_reg_186.read();
    }
    if ((esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read()) && esl_seteq<1,1,1>(exitcond_fu_147_p2.read(), ap_const_lv1_0) && !ap_sig_bdd_86.read())) {
        histo_addr_1_reg_191 =  (sc_lv<8>) (tmp_3_fu_163_p1.read());
    }
    if ((esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read()) && !ap_sig_bdd_86.read())) {
        idxPixel_1_reg_186 = idxPixel_1_fu_153_p2.read();
    }
}
...
void doHist::thread_ap_sig_bdd_86() {
    ap_sig_bdd_86 = (esl_seteq<1,1,1>(inStream_TVALID.read(), ap_const_logic_0) && esl_seteq<1,1,1>(exitcond_fu_147_p2.read(), ap_const_lv1_0));
}

void doHist::thread_doHist_CRTL_BUS_s_axi_U_ap_dummy_ce() {
    doHist_CRTL_BUS_s_axi_U_ap_dummy_ce = ap_const_logic_1;
}

void doHist::thread_exitcond2_fu_130_p2() {
    exitcond2_fu_130_p2 = (!idxHist_reg_107.read().is_01() || !ap_const_lv9_100.is_01())? sc_lv<1>(): sc_lv<1>(idxHist_reg_107.read() == ap_const_lv9_100);
}

void doHist::thread_exitcond_fu_147_p2() {
    exitcond_fu_147_p2 = (!idxPixel_reg_118.read().is_01() || !ap_const_lv17_12C00.is_01())? sc_lv<1>(): sc_lv<1>(idxPixel_reg_118.read() == ap_const_lv17_12C00);
}
...
void doHist::thread_histo_Addr_A_orig() {
    if (esl_seteq<1,2,2>(ap_ST_st4_fsm_3, ap_CS_fsm.read())) {
        histo_Addr_A_orig =  (sc_lv<32>) (histo_addr_1_reg_191.read());
    } else if (esl_seteq<1,2,2>(ap_ST_st2_fsm_1, ap_CS_fsm.read())) {
        histo_Addr_A_orig =  (sc_lv<32>) (tmp_fu_142_p1.read());
    } else if (esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read())) {
        histo_Addr_A_orig =  (sc_lv<32>) (tmp_3_fu_163_p1.read());
    } else {
...
void doHist::thread_histo_Din_A() {
    if (esl_seteq<1,2,2>(ap_ST_st4_fsm_3, ap_CS_fsm.read())) {
        histo_Din_A = tmp_4_fu_168_p2.read();
    } else if (esl_seteq<1,2,2>(ap_ST_st2_fsm_1, ap_CS_fsm.read())) {
...
void doHist::thread_idxHist_1_fu_136_p2() {
    idxHist_1_fu_136_p2 = (!idxHist_reg_107.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_bigint<9>(idxHist_reg_107.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void doHist::thread_idxPixel_1_fu_153_p2() {
    idxPixel_1_fu_153_p2 = (!idxPixel_reg_118.read().is_01() || !ap_const_lv17_1.is_01())? sc_lv<17>(): (sc_bigint<17>(idxPixel_reg_118.read()) + sc_biguint<17>(ap_const_lv17_1));
}
...
void doHist::thread_tmp_3_fu_163_p1() {
    tmp_3_fu_163_p1 = esl_zext<64,8>(inStream_TDATA.read());
}

void doHist::thread_tmp_4_fu_168_p2() {
    tmp_4_fu_168_p2 = (!histo_Dout_A.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_bigint<32>(histo_Dout_A.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void doHist::thread_tmp_fu_142_p1() {
    tmp_fu_142_p1 = esl_zext<64,9>(idxHist_reg_107.read());
}
...
void doHist::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 0 : 
            ...
            break;
        case 1 : 
            if (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_130_p2.read())) {
                ap_NS_fsm = ap_ST_st2_fsm_1;
            } else {
            ...
            break;
        case 2 : 
            if ((!ap_sig_bdd_86.read() && !esl_seteq<1,1,1>(exitcond_fu_147_p2.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_st1_fsm_0;
            } else if ((esl_seteq<1,1,1>(exitcond_fu_147_p2.read(), ap_const_lv1_0) && !ap_sig_bdd_86.read())) {
