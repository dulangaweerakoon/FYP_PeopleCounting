...
`define AUTOTB_DUT      doHistStretch
`define AUTOTB_DUT_INST AESL_inst_doHistStretch
`define AUTOTB_TOP      apatb_doHistStretch_top
`define AUTOTB_LAT_RESULT_FILE "doHistStretch.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "doHistStretch.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_doHistStretch_top
...
`define LENGTH_xMin 1
`define LENGTH_xMax 1
...
`define AUTOTB_TVIN_inStream_V_data_V  "./c.doHistStretch.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.doHistStretch.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.doHistStretch.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.doHistStretch.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.doHistStretch.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.doHistStretch.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.doHistStretch.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V  "./c.doHistStretch.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.doHistStretch.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.doHistStretch.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.doHistStretch.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.doHistStretch.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.doHistStretch.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.doHistStretch.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_xMin  "./c.doHistStretch.autotvin_xMin.dat"
`define AUTOTB_TVIN_xMax  "./c.doHistStretch.autotvin_xMax.dat"
`define AUTOTB_TVIN_inStream_V_data_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.doHistStretch.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.doHistStretch.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_xMin_out_wrapc  "./rtl.doHistStretch.autotvin_xMin.dat"
`define AUTOTB_TVIN_xMax_out_wrapc  "./rtl.doHistStretch.autotvin_xMax.dat"
`define AUTOTB_TVOUT_outStream_V_data_V  "./c.doHistStretch.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.doHistStretch.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.doHistStretch.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.doHistStretch.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.doHistStretch.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.doHistStretch.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.doHistStretch.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.doHistStretch.autotvout_outStream_V_dest_V.dat"
...
initial begin : generate_done_cnt_proc
    ...
    @(posedge AESL_clock);
    # 0.4;
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_data_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_keep_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_strb_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_user_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_last_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_id_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doHistStretch.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doHistStretch.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doHistStretch.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doHistStretch.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.doHistStretch.autotvout_outStream_V_dest_V.dat with impl_rtl.doHistStretch.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
