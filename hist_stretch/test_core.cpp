...
#define INPUT_IMAGE_CORE "A:\\FYP\\HLSTutorials\\test.jpg"
#define OUTPUT_IMAGE_CORE "testOut.jpg"
...
int main(){
	...
	//Populate input stream with the image bytes
	...
	doHistStretch(inputStream,outputStream,0,255);
